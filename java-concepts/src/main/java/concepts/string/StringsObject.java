...
//Immutable - So its thread safe. It can be passed around, between methods and across threads, without worrying about whether the actual String object it's pointing to will change If any change a new object will be created.
...
public class StringsObject {
	...
	public static void main(String[] args) {
		...
		System.out.println(" s == s1 "+ ( literal == constructor));   //FALSE
		System.out.println(" s == s2 "+ ( literal == intern));    //TRUE
	}
